package com.thepegeekapps.juniorpegames.util;
...
public class TemplateParser {
	...
	protected String STUDENTS_TEMPLATE = "<div class=\"textContent\">" +
			"<div class=\"textTitle\" align=\"center\">Students</div>" +
			"<div class=\"textBody\"><p align=\"center\">{students}</p></div><div>";
	...
	protected void parseTemplate() {
		try {
			String body = "";
			if (game.hasStudents()) {
				body += STUDENTS_TEMPLATE.replace(TAG_STUDENTS, game.getStudents());
			}
			if (game.hasArea())
