package com.thepegeekapps.juniorpegames.model;
...
public class Game implements Comparable<Game> {
	...
	public static final String DEFAULT_STUDENTS = "No students";
	...
	public Game() {
		this(0, 0, DEFAULT_TITLE, DEFAULT_STUDENTS, DEFAULT_AREA, 
				DEFAULT_EQUIPMENT, DEFAULT_INSTRUCTIONS, DEFAULT_VARIATION, false);
	}
	
	public Game(int id, int categoryId, String title, String students, String area, 
	...
	public boolean hasStudents() {
		return (students != null) && !(students.equals("") || students.equals(" "));
	}
