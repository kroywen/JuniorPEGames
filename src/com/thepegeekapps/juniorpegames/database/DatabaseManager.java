...
import com.thepegeekapps.juniorpegames.model.Category;
...
public class DatabaseManager {
			...
			if (c.moveToFirst()) {
				...
				do {
					games.add(new Game(
						...
						c.getString(c.getColumnIndex(DatabaseHelper.FIELD_TITLE)),
						c.getString(c.getColumnIndex(DatabaseHelper.FIELD_STUDENTS)),
	...
	public boolean addGame(Game game) {
		...
		values.put(DatabaseHelper.FIELD_STUDENTS, game.getStudents());
